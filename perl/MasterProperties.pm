...
#  4 August 2005 - defect #44 (raised at mysql.com - waiting for bug confirmation)
...

{
   ...
   if ($sqlClient)
   {
      ...
      {
         $whereClause .= " AND StreetName is null";  # (this is never null though)
      }
      ...
      {
         $whereClause .= " AND StreetNumber is null"; # (this shouldn't be null though)
      }
